...
- Обновлена зависимость webview2 до 0.2 и приведён Windows‑host к актуальному API.
- Прокси‑сервер переведён на синхронную обработку без tokio::spawn для совместимости с !Send adblock.
